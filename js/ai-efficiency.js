(function (root) {
    ...
    const SCRIPTS = [
        ...
        ['js/world-map-v10-mobile-layout.js?v=20260820-world-map-mobile-layout-1', 'data-world-map-mobile-layout', 'CronacheWorldMapV10MobileLayout', 'document'],
        ['js/world-map-v10-local-places.js?v=20260820-world-map-local-places-2', 'data-world-map-local-places', 'CronacheWorldMapV10LocalPlaces', 'document'],
        ['js/world-map-v11-levels.js?v=20260820-world-map-levels-2', 'data-world-map-levels', 'CronacheWorldMapV11Levels', 'document'],
        ...
        ['js/npc-name-coherence-v20.js?v=20260821-npc-name-canon-1', 'data-npc-name-coherence-v20', 'CronacheNpcNameCoherenceV20', 'none']
